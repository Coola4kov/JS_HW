...
const gallery = {
  ...
  openImage(src) {
    ...
    this.getWorkSrc(src);
    this.getScreenContainer().querySelector(`.${this.settings.openedImageClass}`).src = this.settings.src;
  },
  ...
  getWorkSrc(src) {
    let trialSrc = new Image();
    trialSrc.onload = this.getWorkingSrc(src);
    trialSrc.onerror = this.getErrorSrc();
    trialSrc.src = src;
    console.log(this.settings.src)
  },

  getErrorSrc(){
    this.settings.src = 'images/gallery/error.png'
  },
